...
summary <- cor_viz |>
  ...
  summarise(
    ...
    cpg_cross_listed_regions = sum(str_detect(ucsc_ref_gene_group, "TSS") + str_detect(ucsc_ref_gene_group, "Body") + str_detect(ucsc_ref_gene_group, "3UTR") + str_detect(ucsc_ref_gene_group, "5UTR") > 1)
  )
